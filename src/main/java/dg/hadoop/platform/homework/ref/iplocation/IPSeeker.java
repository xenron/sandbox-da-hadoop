...
package dg.hadoop.platform.homework.ref.iplocation;
...
public class IPSeeker {
	...
	private Hashtable<String,Object> ipCache;
	// 随机文件访问类
	 ...
	 */
	private IPSeeker() {
		ipCache = new Hashtable<String,Object>();
		loc = new IPLocation();
		buf = new byte[100];
		b4 = new byte[4];
		b3 = new byte[3];
	 ...
	 */
	public List<String> getIPEntriesDebug(String s) {
	 ...
	 * @return 包含IPEntry类型的List
	 */
	public List<String> getIPEntries(String s) {
		List<String> ret = new ArrayList<String>();
		try {
			// 映射IP信息文件到内存中
			if (mbb == null) {
	...
	public static void main(String[] args) {
		...
		String address = ipseeker.getAddress("119.40.7.27");
