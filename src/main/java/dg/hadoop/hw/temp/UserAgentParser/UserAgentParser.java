package dg.hadoop.hw.temp.UserAgentParser;
...
public class UserAgentParser {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * Windows NT 6.1
		 **/
		String explorerAddress = "Mozilla/5.0 (Windows NT 6.1) AppleWebKit/535.7 (KHTML, like Gecko) Chrome/16.0.912.63 Safari/535.7";
		UserAgentParser uagent = new UserAgentParser(explorerAddress);
		System.out.println(uagent.getBrowserName() + " Version:"
				+ uagent.getBrowserVersion() + "\n"
				+ uagent.getBrowserOperatingSystem());
	}
